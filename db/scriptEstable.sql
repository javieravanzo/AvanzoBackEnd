...
CREATE TABLE IF NOT EXISTS `mydb`.`Client` (
  ...
  UNIQUE INDEX `identificationId_UNIQUE` (`identificationId` ASC)  ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`CompanyMembers` (
  `idCompanyMembers` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `mydb`.`CompanySalaries` (
  `idCompanySalaries` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `mydb`.`DocumentTypes` (
  `idDocumentTypes` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `mydb`.`PreRequestDates` (
  `idPreRequestDates` INT NOT NULL AUTO_INCREMENT,
