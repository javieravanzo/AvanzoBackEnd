...
REQUEST_STATE = {
  ...
  APPROVED_HHRR: 2,	                        //APROBADA POR RECURSOS HUMANOS
  ADMINISTRATION_APPROVED: 3,	              //APROBADA ADMINISTRACION
  IN_DISBURSEMENT: 4,	                      //EN DESEMBOLSO
  FINISHED: 5,	                            //FINALIZADA
  HERRED_DOCUMENTS: 6,	                    //DOCUMENTOS HERRADOS
  REJECTED: 7,	                            //RECHAZADA
  BANK_RETURN:8,	                        //DEVOLUCION BANCARIA
  PROCESSED_WITHOUT_CHANGE: 9,	            //PROCESADA SIN CAMBIO
  PROCESSED_DOCUMENTS_WITH_CHANGE: 10,      //PROCESADA DOCUMENTOS CON CAMBIOS
  REJECTED_BY_THE_BANK: 11,                 //RECHAZADA POR EL BANCO
  PENDING_DISBURSEMENT_BY_BANK: 12          //PENDIENTE DESEMBOLSAR POR BANCO
}
...
//FILES
const PATH_FILE_CONTRACT = "../files/contracts/";
...
const CUSTOMER_CONTRACT = "customerContract";
...
module.exports = {
  ...
  NAME_FILE_CONTRACT, PENDING_APPROVAL, ACCOUNT_CONFIRMATION, ACCOUNT_REJECTED, STATE, PRE_CLIENT_STATES, ROLES, CUSTOMER_CONTRACT,REQUEST_STATE,TRANSACTION_CODE
}